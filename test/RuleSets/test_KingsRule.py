...
class TestKingsRule(TestCase):
    ...
    def test_getAffectedPlaces(self):
        ...
        expected_i = np.array([1, 1, 0])
        expected_j = np.array([1, 0, 1])
        ...
        expected_i = np.array([1, 1, 1, 0, 0])
        expected_j = np.array([5, 3, 4, 3, 5])
        ...
        expected_i = np.array([1, 1, 3, 3, 1, 3, 2, 2])
        expected_j = np.array([5, 3, 5, 3, 4, 4, 3, 5])
